...
namespace Runtime.Gameplay.EntitySystem
{
    public class ProjectileStrategy<T> : IProjectileStrategy where T : ProjectileStrategyData
    {
        ...
        public virtual void Init(ProjectileStrategyData projectileStrategyData, Projectile controllerProjectile, Vector2 direction, Vector2 originalPosition, Vector2 targetPosition, IEntityData targetData = null)
        {
